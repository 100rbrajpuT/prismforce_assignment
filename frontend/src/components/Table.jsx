...
const Table = () => {
    ...
    const getRevenue =()=>{
        ...
        axios.get("https://backend-ten-blush.vercel.app/revenue")
        .then((res)=>{
            setRev(res.data)
        })
    }
    ...
    const getExpance =()=>{
        ...
        axios.get("https://backend-ten-blush.vercel.app/expense")
        .then((res)=>{
            setExp(res.data)
        })
    }
    ...
    const getBalance =()=>{
        ...
        axios.get("https://backend-ten-blush.vercel.app/balance")
        .then((res)=>{
            setBal(res.data)
        })
    }
